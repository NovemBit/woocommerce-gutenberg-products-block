...
const Edit = ( { attributes, setAttributes, debouncedSpeak } ) => {
	...
	const noAttributesPlaceholder = () => (
		...
		>
			...
			<Button
				className="wc-block-color-attribute-filter__add-attribute-button"
				isSecondary
				href={ getAdminLink(
	...
	const onDone = () => {
		...
		debouncedSpeak(
			__(
				'Showing Filter Products by Color Attribute block preview.',
				'woo-gutenberg-products-block'
			)
		);
	};
	...
	const renderEditMode = () => {
		return (
			...
			>
				<div className="wc-block-color-attribute-filter__selection">
					{ renderAttributeControl() }
